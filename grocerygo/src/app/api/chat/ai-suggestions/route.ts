...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `You are a professional delivery assistant chatbot. You wil be given:
        ...
        -Must be helpful, respectful, and relevant to delivery, status, help, or locaiton.
    ...
    console.log("Api error in ai suggestions",error)
    return NextResponse.json({
        message:`Internal Server error-GEMINI: ${error}`
    },{status:500})
  }
}
