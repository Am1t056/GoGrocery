    ...
    <div className="pt-28 w-[90%] md:w-[80%] mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10 ">
        {stats.map((stat, index) => {
          const icons = [
            <Package key="p" className="text-green-700 size-6" />,
            <Users key="u" className="text-green-700 size-6" />,
            <Truck key="t" className="text-green-700 size-6" />,
            <DollarSign key="d" className="text-green-700 size-6" />,
          ];
          return (
            <motion.div
              key={index}
