        ...
        <div className="w-[90%] md:w-[80%] mx-auto py-10 grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-green-500/40">
          ...
          <div>
            ...
            <ul className="space-y-2 text-green-100 text-sm">
                ...
                <li className="flex items-center gap-2">
                    <Phone size={16}/> +977 98612819987
                </li>
                <li className="flex items-center gap-2">
                    <Mail size={16}/> support@grocerygo.com
                </li>
                <li className="flex items-center gap-2">
                    <MapPin size={16}/> Kathmandu, Nepal
                </li>
            ...
            <div className="flex gap-4 mt-4">
                ...
                <Facebook className="size-5 hover:text-white transition"/>
                </Link>
                  <Link href={"https://instagram.com"} target="_blank">
                <Instagram className="size-5 hover:text-white transition"/>
                </Link>
                  <Link href={"https://twitter.com"} target="_blank">
                <Twitter className="size-5 hover:text-white transition"/>
                </Link>
